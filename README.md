...
If you sometimes encounter an error message like "image file is truncated" or "cannot identify image file " during image processing or "local variable 'child' referenced before assignment"  ( e.g  in download ), simply restart the runtime (Runtime -> Restart runtime ... or Ctrl + M) and run the cell again.
